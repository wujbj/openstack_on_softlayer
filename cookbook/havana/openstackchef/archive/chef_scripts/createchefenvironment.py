...
def generate_knife_commands(localknifefile, localrolesfile, clusterelement, overwrite_chef_definitions) :
  ...
  chefpath = "../openstack-installation"
...
os.system("cp "+chefpath+"/environment/default-environment.json "+localchefenvfile);
os.system("cp "+chefpath+"/environment/default-environment.map "+localmapfile);
os.system("cp "+chefpath+"/environment/default-environment.roles "+localrolesfile);
...
os.system("cp " + localchefenvfile + " " +chefpath+"/environment/"+clustername+".json");
