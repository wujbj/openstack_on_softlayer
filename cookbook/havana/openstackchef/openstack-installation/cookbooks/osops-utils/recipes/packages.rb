...
#node.set_unless['package_component'] = "grizzly"
...
when "fedora", "redhat", "centos", "scientific", "amazon"
  ...
  #if node['package_component'] == "folsom-ibm"
  #  yum_repository "folsom-ibm" do
  #    repo_name "folsom-ibm"
  #    description "OpenStack folsom packages"
  #    url "http://rchgsa.ibm.com/projects/e/emsol/ccs/build/driver/300/openstack/latest-bld/noarch/"
  #    enabled 1
  #    action :add
  #  end
  #end
