...
actions :recreate_endpoint, :create_service, :delete_service, :create_endpoint, :delete_endpoint, :create_tenant, :create_user, :create_role, :grant_role
...
attribute :service_type, :kind_of => String, :equal_to => [ "image", "identity", "compute", "storage", "network", "ec2", "volume", "object-store", "vil" ]
