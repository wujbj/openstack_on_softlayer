...
default["keystone"]["db"]["password"] = "password"
default["keystone"]["admin_token"] = "password"

default["keystone"]["simple_token_secret"] = "EzzNhXb17ZsOu9j18Ek7jg=="
...
default["keystone"]["services"]["admin-api"]["network"] = "management"            # node_attribute
...
# Logging stuff
default["keystone"]["syslog"]["use"] = "false"                                 # node_attribute
...
when "fedora", "redhat", "centos"                                 # :pragma-foodcritic: ~FC024 - won't fix this
  default["keystone"]["platform"] = {                                       # node_attribute
    ...
    "keystone_packages" => [ "openstack-keystone", "python-iso8601", "ibm-simpletoken-authenticator-middleware", "python-argparse", "openstack-utils" ],
