...
Chef::Log.debug("openstack-compute-havana::nova-common:keystone|#{keystone}")
Chef::Log.debug("openstack-compute-havana::nova-common:ksadmin_user|#{ksadmin_user}")
Chef::Log.debug("openstack-compute-havana::nova-common:ksadmin_tenant_name|#{ksadmin_tenant_name}")
Chef::Log.debug("openstack-compute-havana::nova-common:identity_endpoint|#{identity_endpoint.to_s}")
Chef::Log.debug("openstack-compute-havana::nova-common:xvpvnc_endpoint|#{xvpvnc_endpoint.to_s}")
Chef::Log.debug("openstack-compute-havana::nova-common:novnc_endpoint|#{novnc_endpoint.to_s}")
Chef::Log.debug("openstack-compute-havana::nova-common:compute_api_endpoint|#{::URI.decode compute_api_endpoint.to_s}")
Chef::Log.debug("openstack-compute-havana::nova-common:ec2_public_endpoint|#{ec2_public_endpoint.to_s}")
Chef::Log.debug("openstack-compute-havana::nova-common:network_endpoint|#{network_endpoint.to_s}")
Chef::Log.debug("openstack-compute-havana::nova-common:image_endpoint|#{image_endpoint.to_s}")
