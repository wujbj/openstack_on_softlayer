...
include_recipe "openstack-compute-havana::nova-common"
include_recipe "openstack-compute-havana::api-metadata"
unless node.run_list.include? "openstack-network-havana::server"
  include_recipe "openstack-compute-havana::network"
end
...
include_recipe "openstack-compute-havana::libvirt"
