...
services=(mysqld openstack-keystone qpidd keepalived haproxy \
        ...
        quantum-server quantum-dhcp-agent quantum-l3-agent openvswitch \
        quantum-openvswitch-agent quantum-metadata-agent quantum-ovs-cleanup \
...
packages=(mysql mysql-server chef haproxy keepalived sshpass \
        ...
        python-quantumclient python-quantum openstack-quantum-openvswitch \
        openstack-quantum openstack-quantum-metaplugin \
...
scepackages=(python-cinder-sce openstack-cinder-sce \
        ...
        openstack-quantum-openvswitch-sce \
        openstack-neutron-openvswitch-sce \
        python-glance-sce )

users=(keystone glance nova cinder quantum neutron)
...
files=(/var/lib/mysql /var/log/mysql /etc/my.cnf /etc/mysql* \
        ...
        /etc/qpid /etc/qpidd.* /var/lib/qpidd \
        ...
        /etc/quantum /var/lib/quantum /var/log/quantum \
        /etc/neutron /var/lib/neutron /var/log/neutron \
        /etc/iptables.d /usr/sbin/rebuild-iptables /etc/openstack-dashboard \
        /tmp/images \
	/var/cache/quantum /var/cache/neutron /var/cache/glance /var/cache/cinder /var/cache/nova)
